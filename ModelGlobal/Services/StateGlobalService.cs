...
namespace ModelGlobal.Services
{
    public class StateGlobalService : BaseService, IRepoState<StateGlobal>
    {
        ...
        {
            Command command = new Command("Delete FROM State WHERE Id=@Id");
        ...
        {
            Command command = new Command("Select * FROM State");
        ...
        {
            Command command = new Command("Select * FROM State WHERE id=@id");
            command.AddParameter("id", id);
        ...
        {
            Command command = new Command("INSERT INTO State (StateType) output inserted.id VALUES (@StateType);");
        ...
        {
            Command command = new Command("UPDATE State Set StateType=@StateType WHERE id=@id");
