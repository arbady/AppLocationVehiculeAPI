...
namespace ModelGlobal.Services
{
    public class MarkGlobalService : BaseService, IRepoMark<MarkGlobal>
    {
        ...
        {
            Command command = new Command("Delete FROM Mark WHERE Id=@Id");
        ...
        {
            Command command = new Command("Select * FROM Mark");
        ...
        {
            Command command = new Command("Select * FROM Mark WHERE id=@id");
            command.AddParameter("id", id);
        ...
        public int Post(MarkGlobal mark)
        {
            Command command = new Command
                ("INSERT INTO Mark ([Name]) output inserted.id VALUES (@Name);");
        ...
        {
            Command command = new Command("UPDATE Mark Set [Name]=@Name WHERE id=@id");
